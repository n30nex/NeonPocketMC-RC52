...
#define PIN_USER_BTN            (42)  // P1.10, external pull-up, active low
...
#define SX126X_RESET            (32)  // P1.00
#define SX126X_RXEN             (39)  // P1.07
...
// Hard low-voltage shutdown stays disabled until this RC52 ADC is calibrated.
